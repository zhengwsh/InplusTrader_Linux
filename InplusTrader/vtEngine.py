...
from futureBacktest.futureBacktestEngine import FutureBacktestEngine
from stockBacktest.stockBacktestEngine import StockBacktestEngine
...
class MainEngine(object):
    ...
    def __init__(self):
        ...
        self.futureBacktestEngine = FutureBacktestEngine(self,  self.eventEngine)
        self.stockBacktestEngine = StockBacktestEngine(self, self.eventEngine)
