...
def quotes_historical_yahoo_ochl(ticker, date1, date2, asobject=False, adjusted=True, cachename=None):
...
def _quotes_historical_yahoo(ticker, date1, date2, asobject=False, djusted=True, cachename=None, ochl=True):
    """ Get historical data for ticker between date1 and date2.
...
def _plot_day_summary(ax, quotes, ticksize=3, colorup='r', colordown='g', ochl=True ):
    """Plots day summary
...
def candlestick_ohlc(ax, quotes, width=0.2, colorup='r', colordown='g', alpha=1.0):
...
def _candlestick(ax, quotes, width=0.2, colorup='r', colordown='g', alpha=1.0, ochl=True):
...
def plot_day_summary2_ochl(ax, opens, closes, highs, lows, ticksize=4, colorup='r', colordown='g',):
...
def plot_day_summary2_ohlc(ax, opens, highs, lows, closes, ticksize=4, colorup='r', colordown='g',):
...
def candlestick2_ochl(ax, opens, closes, highs, lows,  width=4, colorup='r', colordown='g', alpha=0.75, ):
...
def candlestick2_ohlc(ax, opens, highs, lows, closes, width=4, colorup='r', colordown='g', alpha=0.75, ):
    """Represent the open, close as a bar line and high low range as a
    vertical line.
...
def volume_overlay2(ax, closes, volumes, colorup='r', colordown='g', width=4, alpha=1.0):
    """
...
def volume_overlay3(ax, quotes, colorup='r', colordown='g', width=4, alpha=1.0):
