...
class StockStrategyManager(QtGui.QGroupBox):
    ...
    def __init__(self, stockBacktestEngine, eventEngine, name, runID, parent=None):
        ...
        with open(os.path.abspath(os.path.dirname(__file__)) + '/config_template.json', 'r') as f:
            ...
            self.setting['mod']['sys_analyser']['output_file'] = os.path.abspath(os.path.dirname(__file__)) + '/result/' + self.name + '/result.pkl'
            self.setting['mod']['sys_analyser']['plot'] = os.path.expanduser("~")
            self.setting['mod']['sys_analyser']['plot_save_file'] = os.path.abspath(os.path.dirname(__file__)) + '/result/' + self.name + '/result.png'
            self.setting['mod']['sys_analyser']['report_save_path'] = os.path.abspath(os.path.dirname(__file__)) + '/result/'
